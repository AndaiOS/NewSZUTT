...
- (void)viewConfig
{
    ...
    if (_subTitle == nil) {
        ...
        _subTitleLabel.textColor = [UIColor colorWithRed:0.0/255 green:191.0/255 blue:255.0/255 alpha:1];
...
- (void)setSelected:(BOOL)selected
{
    ...
    _mainTitleLabel.textColor = selected ? [UIColor colorWithRed:0.0/255 green:191.0/255 blue:255.0/255 alpha:1]: kDropdownMenuTitleColor;
    if (selected) {
...
- (void)setArrowColor:(UIColor *)arrowColor
{
    ...
    _shapeLayer.fillColor = [UIColor colorWithRed:0.0/255 green:191.0/255 blue:255.0/255 alpha:1].CGColor;
}
