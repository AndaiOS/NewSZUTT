...
- (id)init {
    self = [super init];
    if (self) {
        //此处报错 use of undecleared identifier UIScreen 因为没有导入 UIKit库
        ...
        self.backgroundColor = [[UIColor colorWithRed:239.0/255 green:42.0/255 blue:42.0/255 alpha:1] CGColor];
